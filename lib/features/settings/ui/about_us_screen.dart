...
class AboutUsScreen extends StatelessWidget {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Qwok is the ultimate platform connecting talented freelancers and job seekers with innovative companies. We strive to create a seamless experience for finding work and hiring top talent.",
                        style: TextStyleHelper.instance.body14Medium
                            .copyWith(color: appTheme.gray700, height: 1.5),
                      ),
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 8.h),
                            Text(
                              "© 2024 Qwok Inc. All rights reserved.",
                              style: TextStyleHelper.instance.body12Medium
  ...
  Widget _buildFeatureItem(String text) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(Icons.check_circle, color: appTheme.indigoA700, size: 20.h),
          SizedBox(width: 12.w),
          Expanded(
            child: Text(
              text,
