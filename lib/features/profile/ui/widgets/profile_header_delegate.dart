  ...
  Widget build(
    ...
    final double expandedOpacity =
        const Interval(0.0, 0.3, curve: Curves.easeIn)
            .transform(1.0 - rawProgress);

    final double collapsedOpacity =
        const Interval(0.7, 1.0, curve: Curves.easeIn).transform(rawProgress);
            ...
            child: Opacity(
              ...
              child: ClipRect(
                child: BackdropFilter(
                  ...
                  child: Container(
                      color: CustomColors.lightBg.withValues(alpha: 0.85)),
                ),
              ),
            ),
          ),
  ...
  Widget _buildAvatar(double size, double progress) {
    return Stack(
      ...
      children: [
        ...
        if (isCurrentUser && onEditTap != null && progress < 0.3)
          Positioned(
            bottom: 0,
            right: 0,
