...
class _ContractDetailsScreenState extends State<ContractDetailsScreen> {
  ...
  Widget _buildContractInfo(Contract contract, DateFormat dateFormat) {
    return _buildCard(
  ...
  Widget _buildFinancialDetails(Contract contract) {
  ...
  Widget _buildTimeline(Contract contract, DateFormat dateFormat) {
    final duration =
  ...
  Widget _buildSignatures(Contract contract, DateFormat dateTimeFormat) {
    return _buildCard(
      title: 'Signatures',
      child: Column(
        children: [
