...
import 'package:work_hub/presentation/screens/worker/reels/reel_player.dart';
              ...
              Row(
                children: [
                  CircleAvatar(
                    radius: 20.h,
                    backgroundImage:
                        ImageUtils.getImageProvider(widget.ad.userPhotoUrl),
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(
                              widget.ad.username ?? "Sponsored Partner",
                              style:
