...
class TextStyleHelper {
  ...
  TextStyle get headline22Bold => GoogleFonts.outfit(
        fontSize: 22.0,
        fontWeight: FontWeight.w700,
        color: CustomColors.darkText,
      );

  TextStyle get title20SemiBold => GoogleFonts.outfit(
        fontSize: 20.0,
        fontWeight: FontWeight.w600,
        color: CustomColors.darkText,
      );

  TextStyle get title20Black => GoogleFonts.outfit(
        fontSize: 20.0,
  ...
  TextStyle get headline30Bold => GoogleFonts.outfit(
        fontSize: 30.0,
        fontWeight: FontWeight.w700,
        color: CustomColors.darkText,
      );
